...
struct	pentry	{
	...
	/* modified for linux like scheduling */
	int pcounter;  /* how many ticks are left from its quantum */
	int newpprio; /* in case of priority changes in the middle of an epoch.  */
